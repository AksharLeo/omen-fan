...
- `mkdir -p omen-fan-build && cd omen-fan-build && curl -LO https://raw.githubusercontent.com/AksharLeo/omen-fan/main/PKGBUILD && makepkg -si --clean && cd .. && rm -rf omen-fan-build`
